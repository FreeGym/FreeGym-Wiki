...
The "fiber slows absorption" idea can be tested directly in postprandial crossover trials.
...
Best evidence-based answer: juice does not look identical to soda, but it also does not look identical to whole fruit.

### Juice vs soda: T2D risk magnitude
